      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 pb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {articles.map((art) => (
            <article
              key={art.slug}
              className="bg-white border border-[#b5a898]/30 overflow-hidden flex flex-col justify-between hover:border-black transition-all duration-300 group"
            >
              <div>
              ...
              <div className="p-8 pt-0">
                <span className="text-xs tracking-[0.16em] uppercase font-semibold text-black border-b border-black/30 pb-0.5 group-hover:border-black">
