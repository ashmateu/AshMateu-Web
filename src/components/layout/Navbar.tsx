...
export default function Navbar() {
  ...
  const navLinks = [
    { label: "WHAT I DO?", href: "/como-trabajo" },
    { label: "FASHION GALLERY", href: "/galeria" },
    { label: "TRENDS", href: "/blog" },
    { label: "STYLING SERVICES", href: "/como-trabajo#servicios" },
      ...
      >
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <a
              href="https://wa.me/5491138580228?text=Hola%20Ash,%20te%20escribo%20desde%20tu%20sitio%20web"
              target="_blank"
