    ...
    <>
      <header
        ...
        style={{
          background: scrolled
            ? undefined
            : "linear-gradient(to bottom, rgba(0, 0, 0, 0.8) 0%, rgba(0, 0, 0, 0.4) 10%, rgba(0, 0, 0, 0) 15%, rgba(0, 0, 0, 0) 100%)",
        }}
      >
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 flex items-center justify-between">
          ...
          <ul className="hidden lg:flex items-center gap-5 xl:gap-7 text-[10px] tracking-[0.28em] uppercase font-medium text-white/85">
            {navLinks.map((link, i) => {
