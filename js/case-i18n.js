...
window.CASE_I18N = {
    'chanel-hc': {
        en: {
            ...
            pullQuote: 'A Manhattan corner at two in the morning with a sequined Chanel dress: that\'s the image.',
            blocks: [
        ...
        fr: {
            ...
            pullQuote: 'Un coin de rue à Manhattan à deux heures du matin avec une robe Chanel à paillettes : voilà l\'image.',
            blocks: [
    ...
    'valentina-ferrer': {
        en: {
            ...
            pullQuote: 'She has a presence that fills the frame. The styling had to support that, not compete with it.',
            blocks: [
        ...
        fr: {
            ...
            pullQuote: 'Elle a une présence qui remplit le cadre. Le styling devait la soutenir, pas lui faire concurrence.',
            blocks: [
    ...
    'leonie-hanne': {
        en: {
            ...
            pullQuote: 'Flawless isn\'t the same as surprising.',
            blocks: [
        ...
        fr: {
            ...
            pullQuote: 'Impeccable n\'est pas synonyme de surprenant.',
            blocks: [
    ...
    'calu-chinatown': {
        en: {
            ...
            pullQuote: 'The best photo of the production wasn\'t the one we had imagined.',
            blocks: [
        ...
        fr: {
            ...
            pullQuote: 'La meilleure photo de la production n\'était pas celle qu\'on avait imaginée.',
            blocks: [
    ...
    'dolores-fonzi': {
        en: {
            ...
            pullQuote: 'She has a very clear aesthetic instinct and a relationship with clothes that comes from within.',
            blocks: [
        ...
        fr: {
            ...
            pullQuote: 'Elle a un sens esthétique très clair et un rapport aux vêtements qui vient de l\'intérieur.',
            blocks: [
    ...
    'chanel-williamsburg': {
        en: {
            ...
            pullQuote: 'Sometimes the location gives you something you didn\'t ask for, and it\'s exactly what you needed.',
            blocks: [
        ...
        fr: {
            ...
            pullQuote: 'Parfois le lieu vous donne quelque chose que vous n\'aviez pas demandé, et c\'est exactement ce dont vous aviez besoin.',
            blocks: [
    ...
    'netflix-mf': {
        en: {
            ...
            pullQuote: 'That\'s the difference between styling and costume.',
            blocks: [
        ...
        fr: {
            ...
            pullQuote: 'C\'est ça, la différence entre le styling et le costume.',
            blocks: [
    ...
    'gucci-rural': {
        en: {
            ...
            pullQuote: 'The tension between both worlds is the image.',
            blocks: [
        ...
        fr: {
            ...
            pullQuote: 'La tension entre les deux mondes, c\'est ça l\'image.',
            blocks: [
