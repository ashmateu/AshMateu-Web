(function () {
    ...
    var TRANSLATIONS = {
        es: {
            ...
            'nav.services':            '¿Cómo Trabajo?',
            'nav.gallery':             'Galería',
            'nav.styling':             'Servicios',
            'nav.press':               'Prensa',
            'nav.work':                'Portfolio',
            'nav.notes':               'Notas',
            'nav.vlog':                'Vlog',
            ...
            'section.services':        'Cómo Trabajo',
            'section.contact':         'Contacto',
            'hero.cta.primary':        '¿Cómo Trabajo?',
            'hero.cta.secondary':      'Escribime por WhatsApp',
            ...
            'footer.home':             'Inicio',
            'about.readMore':          'Leer la historia completa →',
        ...
        en: {
            'nav.history':             'Who I Am?',
            'nav.services':            'What I Do?',
            'nav.gallery':             'Fashion Gallery',
            'nav.styling':             'Styling Services',
            'nav.press':               'Press',
            'nav.work':                'Portfolio',
            'nav.notes':               'Notes',
            'nav.vlog':                'Vlog',
            ...
            'hero.cta.primary':        'What I Do',
            'hero.cta.secondary':      'WhatsApp Me',
            ...
            'footer.home':             'Home',
            'about.readMore':          'Read the full story →',
            'hero.title':              'Styling <span class="hero-kw">people</span>,<br><span class="hero-kw">brands</span> and <span class="hero-kw">ideas</span>.',
            'hero.subtitle':           'Ash Mateu Prieto · Creative Director & Fashion Consultant',
            'hero.manifest':           '‘I build identity through branding and communication strategies. I specialize in positioning the image of brands and people.’',
            'about.text':              '<p>I\'m a descendant of Spaniards, born in a neighborhood founded by Germans. From age six through my teens I was a competitive gymnast, and that\'s where I learned almost everything that later served me at work: discipline, conviction in process, and the slightly absurd ability to repeat something for months trusting it would eventually click.</p><p>By 19 I was already working at Editorial Perfil, producing fashion shoots. That editorial world became another education, and a relationship that still continues: today I work at Marie Claire Argentina researching, writing, and covering international fashion.</p><p>Chanel, Louis Vuitton, Miu Miu, Dolce & Gabbana, Gucci, Nike, L\'Oréal, Mercedes-Benz. Marie Claire Argentina covers more times than I can exactly recall. Styling for Dolores Fonzi, Griselda Siciliani, Valentina Zenere, and much of the Netflix Argentina cast.</p><p>In 2015 I founded Inside Studios, an online fashion school that reached more than 20,000 students across the region.</p><p>If I had to find one thread through all of this, it\'s fairly simple: I like reading. Reading people, brands, cultures, moments, and turning that into an identity, a strategy, or an idea that can go out into the world.</p><p><a href="/historia">Read the full story →</a></p><p>Available for projects in 2026. The form below is the most direct way in.</p>',
            ...
            'service.3.name':          'Dress to Kill',
            'service.3.desc':          'Styling for brides, red carpets, galas, and events that don\'t repeat. Image consulting for those looking for confidence and identity: so no one ever forgets your dress.',
            'service.4.name':          'Celebrity styling',
            'service.4.desc':          'Red carpets, events, press, appearances. Styling for public figures has its own rules and its own rhythm.',
            'service.5.name':          'Brand consulting',
            'service.5.desc':          'Fashion, beauty, culture. I work on visual identity and communication tone with brands that need a perspective that comes from the set, not a PowerPoint presentation.',
            'service.6.name':          'Trend research & speaker',
            'service.6.desc':          'I analyze what\'s happening in culture before it appears in trends, and translate it into concrete communication decisions. Also available as a speaker on trends and consumer behavior.',
        ...
        fr: {
            'nav.history':             'Mon Histoire',
            'nav.services':            'Comment Je Travaille',
            'nav.gallery':             'Galerie',
            'nav.styling':             'Services Styling',
            'nav.press':               'Presse',
            'nav.work':                'Portfolio',
            'nav.notes':               'Notes',
            'nav.vlog':                'Vlog',
            ...
            'nav.menuLabel':           'Menu',
            'section.work':            'Portfolio',
            'section.services':        'Comment Je Travaille',
            'section.contact':         'Contact',
            'hero.cta.primary':        'Comment Je Travaille',
            'hero.cta.secondary':      'Contactez-moi sur WhatsApp',
            'form.name.label':         'Nom',
            ...
            'footer.contact':          'Contact',
            'footer.home':             'Accueil',
            'about.readMore':          'Lire toute l\'histoire →',
            'hero.title':              'Styling de <span class="hero-kw">personnes</span>,<br><span class="hero-kw">marques</span> et <span class="hero-kw">idées</span>.',
            'hero.subtitle':           'Ash Mateu Prieto · Directrice Créative & Consultante de Mode',
            'about.text':              '<p>Je suis descendante d\'Espagnols, née dans un quartier fondé par des Allemands. De mes six ans jusqu\'à l\'adolescence, j\'ai été gymnaste de haut niveau, et c\'est là que j\'ai appris presque tout ce qui m\'a servi ensuite pour travailler: la discipline, la conviction dans les processus et cette capacité un peu absurde de répéter quelque chose pendant des mois en faisant confiance au résultat.</p><p>À 19 ans je travaillais déjà chez Editorial Perfil, montant des productions de mode. Cet univers éditorial est devenu une autre université et une relation qui continue encore aujourd\'hui: je travaille chez Marie Claire Argentine, où je fais de la recherche, de l\'écriture et des couvertures internationales.</p><p>Chanel, Louis Vuitton, Miu Miu, Dolce & Gabbana, Gucci, Nike, L\'Oréal, Mercedes-Benz. Des couvertures de Marie Claire Argentine plus souvent que je ne saurais le dire avec exactitude. Styling pour Dolores Fonzi, Griselda Siciliani, Valentina Zenere et une bonne partie du casting de Netflix Argentine.</p><p>En 2015, j\'ai fondé Inside Studios, une école de mode en ligne qui a compté plus de 20 000 étudiants dans toute la région.</p><p>S\'il fallait trouver un fil conducteur dans tout ça, c\'est assez simple: j\'aime lire. Lire les gens, les marques, les cultures, les moments, et transformer tout ça en une identité, une stratégie ou une idée qui puisse sortir dans le monde.</p><p><a href="/historia">Lire toute l\'histoire →</a></p><p>Disponible pour des projets en 2026. Le formulaire ci-dessous est le chemin le plus direct.</p>',
            ...
            'service.3.name':          'Dress to Kill',
            'service.3.desc':          'Styling pour mariées, tapis rouges, galas et événements qui ne se répètent pas. Conseil en image pour celles qui cherchent confiance et identité: pour que personne n\'oublie jamais votre robe.',
            'service.4.name':          'Celebrity styling',
            'service.4.desc':          'Tapis rouges, événements, presse, apparitions. Le styling pour les personnalités publiques a ses propres règles et son propre rythme.',
            'service.5.name':          'Conseil de marque',
            'service.5.desc':          'Mode, beauté, culture. Je travaille sur l\'identité visuelle et le ton de communication avec des marques qui ont besoin d\'une perspective qui vient du plateau, pas d\'une présentation PowerPoint.',
            'service.6.name':          'Trend research & speaker',
            'service.6.desc':          'J\'analyse ce qui se passe dans la culture avant que cela n\'apparaisse dans les tendances, et je le traduis en décisions de communication concrètes. Disponible aussi comme speaker sur les tendances et le comportement du consommateur.',
